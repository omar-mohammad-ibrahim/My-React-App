...
export default function ContactHero() {
  return (
    ...
    >
      <form className="flex items-center w-[90%] max-w-[580px] bg-white border-2 border-[#ff4e00] rounded-sm overflow-hidden">
        <input
          className="flex-1 border-none outline-none py-2.5 px-3.5 text-sm text-[#333]"
          type="search"
